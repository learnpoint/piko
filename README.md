...
[Deno](https://deno.land/manual/getting_started/installation) version ```1.14.1``` is required to use Piko.

## Installation

```bash
$ deno install -A https://cdn.jsdelivr.net/gh/learnpoint/piko@0.9.25/piko.js
```
