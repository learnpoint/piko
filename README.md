...
```bash
deno install -g -A --location https://piko.learnpoint.io/ https://cdn.jsdelivr.net/gh/learnpoint/piko@3.1.6/piko.js
```
...
```bash
deno install -g -f -A --location https://piko.learnpoint.io/ https://cdn.jsdelivr.net/gh/learnpoint/piko@3.1.6/piko.js
```
