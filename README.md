...
Follow the [instructions on this page](https://deno.land/manual@v1.36.1/getting_started/installation).
...
```bash
deno install -A --location https://piko.learnpoint.io/ https://cdn.jsdelivr.net/gh/learnpoint/piko@2.1.0/piko.js
```
